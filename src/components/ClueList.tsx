...
// export default function ClueList() {
//   const { puzzle, currentClue, currentDirection, setCurrentClue, setCurrentCell, setCurrentDirection } = useCrossword()
...
//       for (let c = 0; c < puzzle.grid[0].length; c++) {
//         if (
//           puzzle.grid[r][c].clueNumbers &&
//           ((direction === "across" && puzzle.grid[r][c].clueNumbers.across === number) ||
//             (direction === "down" && puzzle.grid[r][c].clueNumbers.down === number))
//         ) {
//           setCurrentCell([r, c])
//           return
//         }
...
//                 key={`across-${clue.number}`}
//                 className={`text-sm cursor-pointer p-1 rounded ${
//                   currentDirection === "across" && currentClue === clue.number ? "bg-blue-100" : "hover:bg-gray-100"
//                 }`}
//                 onClick={() => handleClueClick(clue.number, "across")}
//               >
//                 <span className="font-medium">{clue.number}.</span> {clue.clue}
...
//                 key={`down-${clue.number}`}
//                 className={`text-sm cursor-pointer p-1 rounded ${
//                   currentDirection === "down" && currentClue === clue.number ? "bg-blue-100" : "hover:bg-gray-100"
//                 }`}
//                 onClick={() => handleClueClick(clue.number, "down")}
//               >
//                 <span className="font-medium">{clue.number}.</span> {clue.clue}
